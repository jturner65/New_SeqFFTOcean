package NewSphrSeqFFTVisPKG.ui.base;
...
import NewSphrSeqFFTVisPKG.staff.myTimeSig;
import NewSphrSeqFFTVisPKG.ui.controls.myPlaybackEngine;
...
//		}
	 ...
	 * @return
	 */
	public myPoint getScreenLocation() {return  myPoint._add(sceneOriginVal,focusTar);}
	 ...
	 */
	@Override
	protected final void initAllUIButtons(TreeMap<Integer, Object[]> tmpBtnNamesArray) {
		
		
		return initAllUIButtons(tmpBtnNamesArray);
	}
	public abstract void initAllPrivBtns_Indiv(TreeMap<Integer, Object[]> tmpBtnNamesArray);
